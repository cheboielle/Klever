...
- GitHub origin: https://github.com/cheboielle/Klever.git. Remote empty at inspection. The complete source is committed locally on main using the explicit builder identity Codex <codex@localhost>. Push failed because Git has no GitHub credentials on this computer; no remote source backup is claimed. Interactive authentication was not forced.
