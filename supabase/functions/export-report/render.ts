...
const columns:Record<string,string[]>={assets:['id','name','serial','type','status','meter_unit','current_reading','archived'],logs:['id','asset','reading','unit','delta','performer','capture_time','server_time','correction_of','reason'],services:['id','asset','serial','service','reading','unit','performer','capture_time','server_time','state','cost','currency','mechanic_notes','instructions','corrections','photo_path'],tasks:['id','asset','task','performer','capture_time','server_time','due_date','effective_completion','notes','instructions','checked_ids','corrections','photo_path']};
