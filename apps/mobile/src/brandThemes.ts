import {customTheme} from './brandColour';
export const themes={
...
export function resolveTheme(name:ThemeName){return name in themes?{...themes[name as keyof typeof themes],brand:themes[name as keyof typeof themes].accent,onBrand:'#FFFFFF'}:customTheme(name);}
